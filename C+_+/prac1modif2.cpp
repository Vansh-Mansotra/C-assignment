...
public:
    ...
    void update2() {
        cout << "Update Professor Name: ";
        cin >> proff_name;
        cout << "Update Professor ID: ";
        cin >> proff_id;
        cout << "Update Qualification: ";
        cin >> qualification;
    }
};
...
int main() {
    ...
    // Update data
    int updateIndex;
    cout << "\nEnter index (1-3) of Student to update: ";
    cin >> updateIndex;
    if (updateIndex > 0 && updateIndex <= 3) {
        students[updateIndex - 1].update();
    }

    cout << "\nEnter index (1-3) of Course to update: ";
    cin >> updateIndex;
    if (updateIndex > 0 && updateIndex <= 3) {
        courses[updateIndex - 1].update1();
    }

    cout << "\nEnter index (1-3) of Professor to update: ";
    cin >> updateIndex;
    if (updateIndex > 0 && updateIndex <= 3) {
        professors[updateIndex - 1].update2();
    }

    // Display updated data
    cout << "\nDisplaying updated data:" << endl;
    for (int i = 0; i < 3; i++) {
        students[i].display();
        courses[i].display1();
        professors[i].display2();
